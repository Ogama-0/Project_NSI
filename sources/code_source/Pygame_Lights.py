...
class LIGHT:
    def __init__(self, size : int , pixel_shader : pygame.Surface):
        self.size = size
...
def pixel_shader(size:int, color:tuple[int], intensity:int, point:bool, angle:int=0, angle_width:int=360):
